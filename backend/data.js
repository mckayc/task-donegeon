// This file is a CommonJS version of the frontend's data/initialData.ts
// It removes all TypeScript syntax and converts enums to plain objects
// so the Node.js backend can use it directly without depending on the frontend build process.

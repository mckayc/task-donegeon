...
const BugReporter: React.FC = () => {
    ...
    if (isRecording) {
        return (
             <div className="fixed bottom-0 left-0 right-0 bg-red-900/80 border-t-2 border-red-600 shadow-2xl z-[99] backdrop-blur-sm flex flex-col transition-all duration-300">
                {isLogVisible && (

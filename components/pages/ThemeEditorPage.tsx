                            ...
                            <h3 className="font-semibold text-foreground mb-2">Fonts</h3>
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2">
                                     <Label>Display Size ({parseFloat(s['--font-size-display']).toFixed(1)}rem)</Label>
                                     <Slider defaultValue={[parseFloat(s['--font-size-display'])]} max={6} min={1.5} step={0.1} onValueChange={(v: number[]) => handleStyleChange('--font-size-display', `${v[0]}rem`)} />
                                 </div>
                                 <div className="space-y-2">
                                     <Label>Body Size ({parseFloat(s['--font-size-body']).toFixed(2)}rem)</Label>
                                     <Slider defaultValue={[parseFloat(s['--font-size-body'])]} max={1.5} min={0.8} step={0.05} onValueChange={(v: number[]) => handleStyleChange('--font-size-body', `${v[0]}rem`)} />
                                 </div>
                             </div>
                        </div>

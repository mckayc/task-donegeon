...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    ws.onmessage = (event) => {
        ...
        if (message.type === 'DATA_UPDATED') {
            ...
            // Refetch all data to get the new message and potential notification changes
            refetchData();
        }
    };
  ...
  const notImplementedPromise = useCallback(async () => { notImplemented(); return undefined; }, [notImplemented]);

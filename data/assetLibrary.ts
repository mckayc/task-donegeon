...
export const libraryPacks: LibraryPack[] = [
    ...
    { id: 'pack-q-evening', type: 'Quests', title: 'Evening Wind-Down', description: 'Quests to end the day peacefully and prepared.', color: QUEST_COLOR, assets: { quests: eveningQuests }},
    { id: 'pack-q-kindness', type: 'Quests', title: 'Kindness Crusade', description: 'Quests focused on performing acts of kindness.', color: QUEST_COLOR, assets: { quests: kindnessQuests }},
    { id: 'pack-q-secret', type: 'Quests', title: 'Secret Agent Missions', description: 'Fun, imaginative quests with a spy theme.', color: QUEST_COLOR, assets: { quests: secretAgentQuests }},
    
    // --- ITEMS ---
    { id: 'pack-i-fantasy', type: 'Items', title: 'Fantasy Starter Items', description: 'Basic avatar clothing and gear.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-experiences', type: 'Items', title: 'Real-World Reward Items', description: 'Items that can be redeemed for experiences.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-scifi', type: 'Items', title: 'Sci-Fi Armory Items', description: 'Futuristic avatar gear and companions.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    // ... 6 more item packs
    { id: 'pack-i-potions', type: 'Items', title: 'Alchemist\'s Potions', description: 'Cosmetic potions for your avatar.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-seasonal', type: 'Items', title: 'Seasonal Items', description: 'Cosmetic items for various holidays and seasons.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-pets', type: 'Items', title: 'Creature Companion Items', description: 'A variety of cute cosmetic pets.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-music', type: 'Items', title: 'Musical Instruments', description: 'A collection of cosmetic musical instruments.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-gardening', type: 'Items', title: 'Gardening Supplies', description: 'Tools and accessories for the green-thumbed adventurer.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    { id: 'pack-i-magic', type: 'Items', title: 'Magical Artifacts', description: 'Powerful-looking (but cosmetic) magical items.', color: ITEM_COLOR, assets: { gameAssets: [
    ...
    // --- MARKETS ---
    // (9 total)
    { id: 'pack-m-fantasy-starter', type: 'Markets', title: 'Fantasy Starter Market', description: 'An outfitter market for new heroes.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-fantasy-starter', title: 'The Adventurer\'s Outfitter', description: 'Gear for new heroes.', icon: '👕'})] }},
    { id: 'pack-m-experiences', type: 'Markets', title: 'Real-World Rewards Market', description: 'A market for cashing in points for fun family experiences.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-experiences', title: 'The Treasury of Fun', description: 'Spend your gems on memorable experiences.', icon: '🎬'})] }},
    { id: 'pack-m-scifi-armory', type: 'Markets', title: 'Sci-Fi Armory Market', description: 'A market for futuristic avatar gear and companions.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-scifi-armory', title: 'Starship Outfitters', description: 'Gear for the final frontier.', icon: '🚀'})] }},
    { id: 'pack-m-potion-shop', type: 'Markets', title: 'Alchemist\'s Potion Market', description: 'A market selling cosmetic potions.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-potions', title: 'The Bubbling Cauldron', description: 'Potions that add flair to your avatar.', icon: '⚗️'})] }},
    { id: 'pack-m-seasonal', type: 'Markets', title: 'Seasonal Market', description: 'A market for holidays and seasons.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-seasonal', title: 'The Holiday Stall', description: 'Festive gear for every occasion!', icon: '🎃'})] }},
    { id: 'pack-m-pet-shop', type: 'Markets', title: 'Creature Companion Market', description: 'A place to adopt cosmetic pets.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-pets', title: 'The Cuddly Companion', description: 'Adopt a friend for your adventures!', icon: '🐾'})] }},
    { id: 'pack-m-music', type: 'Markets', title: 'Musician\'s Corner', description: 'For all your musical needs.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-music', title: 'The Bard\'s Stage', description: 'Instruments and musical flair.', icon: '🎵'})] }},
    { id: 'pack-m-gardening', type: 'Markets', title: 'Gardening Guild Market', description: 'Supplies for the aspiring gardener.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-gardening', title: 'The Green Thumb', description: 'Tools and plants for your garden.', icon: '🌻'})] }},
    { id: 'pack-m-magic', type: 'Markets', title: 'Magic & Artifacts Shop', description: 'A shop for powerful and mysterious items.', color: MARKET_COLOR, assets: { markets: [createMarket({ id: 'market-magic', title: 'The Enchanter\'s Study', description: 'Wands, tomes, and artifacts of power.', icon: '✨'})] }},

    // --- TROPHIES ---
    // (9 total)
    { id: 'pack-t-milestones', type: 'Trophies', title: 'Milestone Trophies', description: 'A set of trophies for reaching key milestones.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    { id: 'pack-t-creative', type: 'Trophies', title: 'Creative Achievements', description: 'Awards for creative and artistic endeavors.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    { id: 'pack-t-social', type: 'Trophies', title: 'Social Butterfly', description: 'Awards for positive social interactions.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    { id: 'pack-t-gaming', type: 'Trophies', title: 'Gaming Achievements', description: 'Trophies for video game accomplishments.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    { id: 'pack-t-school', type: 'Trophies', title: 'Academic Awards', description: 'For achievements related to school.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    { id: 'pack-t-funny', type: 'Trophies', title: 'Funny & Silly Awards', description: 'Just for fun awards.', color: TROPHY_COLOR, assets: { trophies: [
    ...
    // --- REWARDS ---
    // (9 total)
    { id: 'pack-r-crafting', type: 'Rewards', title: 'Crafting Materials', description: 'A set of currencies themed around crafting materials.', color: REWARD_COLOR, assets: { rewardTypes: [
    ...
    { id: 'pack-r-social', type: 'Rewards', title: 'Social XP Types', description: 'A set of XP types for rewarding positive social behaviors.', color: REWARD_COLOR, assets: { rewardTypes: [
    ...
    { id: 'pack-r-silly', type: 'Rewards', title: 'Silly Currencies', description: 'Just for fun currencies.', color: REWARD_COLOR, assets: { rewardTypes: [
    ...
    { id: 'pack-r-elemental', type: 'Rewards', title: 'Elemental Essences', description: 'XP based on elements.', color: REWARD_COLOR, assets: { rewardTypes: [
    ...
    { id: 'pack-r-guild', type: 'Rewards', title: 'Guild Currencies', description: 'Currencies for guild activities.', color: REWARD_COLOR, assets: { rewardTypes: [
    ...
    { id: 'pack-r-dnd', type: 'Rewards', title: 'D&D Stats XP', description: 'XP based on the classic D&D stats.', color: REWARD_COLOR, assets: { rewardTypes: [

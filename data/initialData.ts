...
export const createSampleMarkets = (): Market[] => [
    { id: 'market-1', title: 'The Adventurer\'s Outfitter', description: 'Basic gear for new heroes.', icon: '👕', guildId: undefined, status: 'open' },
    { id: 'market-2', title: 'The Treasury of Fun', description: 'Spend your gems on memorable experiences.', icon: '🎬', guildId: undefined, status: 'open' },
    { id: 'market-themes', title: 'The Theme Shoppe', description: 'Purchase new visual themes for your Donegeon!', icon: '🎨', guildId: undefined, status: 'open' },
];

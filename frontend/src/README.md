...
Docker: Install Docker Desktop (docker --version to verify).
...
Replace your_jwt_secret_here with a secure key:openssl rand -base64 32




Run the Application:
In the task-donegeon/ directory, run:docker-compose up --build

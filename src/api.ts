...
export const updateReadingProgressAPI = (questId: string, userId: string, data: { secondsToAdd?: number; sessionSeconds?: number; pageNumber?: number; epubChapter?: string; epubScroll?: number; bookmarks?: Bookmark[]; }) => apiRequest('POST', `/api/quests/${questId}/reading-progress`, { userId, data });

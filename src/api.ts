...
export const updateReadingProgressAPI = (questId: string, userId: string, data: { secondsToAdd?: number; locationCfi?: string; bookmarks?: Bookmark[], pageNumber?: number }) => apiRequest('POST', `/api/quests/${questId}/reading-progress`, { userId, data });

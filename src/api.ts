...
export const bulkApplyModifierAPI = (data: { userIds: string[], modifierDefinitionId: string, reason: string, appliedById: string }) => apiRequest('POST', '/api/applied-modifiers/bulk-apply', data);

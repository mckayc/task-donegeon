...
export const updateReadingProgressAPI = (questId: string, userId: string, data: { secondsToAdd?: number; sessionSeconds?: number; locationCfi?: string; bookmarks?: Bookmark[]; }) => apiRequest('POST', `/api/quests/${questId}/reading-progress`, { userId, data });

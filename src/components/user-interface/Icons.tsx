...
export const UserPlusIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.5 21h-5a12.318 12.318 0 01-3.235-1.765z" />
    </svg>
);

export const UserGroupIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 01-9 0m9 0a4.5 4.5 0 00-9 0m9 0h.008m-3.75 0h.008m-3.75 0h.008m9 0h.008m-3.75 0h.008m-3.75 0h.008M12.75 6.75h.008v.008h-.008V6.75zm-3.75 0h.008v.008h-.008V6.75zm-3.75 0h.008v.008h-.008V6.75z" />
    </svg>
);
...
export const SettingsIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.008 1.11-1.226a21.72 21.72 0 014.592 0c.55.218 1.02.684 1.11 1.226.09.542.09 1.096 0 1.638-.09.542-.56 1.008-1.11 1.226a21.72 21.72 0 01-4.592 0c-.55-.218-1.02-.684-1.11-1.226-.09-.542-.09-1.096 0-1.638zM11.94 12.06c.09-.542.56-1.008 1.11-1.226a21.72 21.72 0 014.592 0c.55.218 1.02.684 1.11 1.226.09.542.09 1.096 0 1.638-.09.542-.56 1.008-1.11 1.226a21.72 21.72 0 01-4.592 0c-.55-.218-1.02-.684-1.11-1.226-.09-.542-.09-1.096 0-1.638zM11.94 20.18c.09-.542.56-1.008 1.11-1.226a21.72 21.72 0 014.592 0c.55.218 1.02.684 1.11 1.226.09.542.09 1.096 0 1.638-.09.542-.56 1.008-1.11 1.226a21.72 21.72 0 01-4.592 0c-.55-.218-1.02-.684-1.11-1.226-.09-.542-.09-1.096 0-1.638zM14.25 12a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" />
    </svg>
);
...
export const DeviceDesktopIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
...
export const DevicePhoneMobileIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75A2.25 2.25 0 0015.75 1.5h-2.25m-3 0V3m3 0V3m0 18v-1.5m-3 0v-1.5m-6-9h12" />
    </svg>
);
...
export const BookmarkSolidIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"}>
        <path fillRule="evenodd" d="M6.32 2.577a49.255 49.255 0 0111.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 01-1.085.67L12 18.082l-5.165 3.589A.75.75 0 015.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93z" clipRule="evenodd" />
    </svg>
);
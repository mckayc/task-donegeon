    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {assetPacks.map((pack, index) => (
          <Card key={pack.title} className="flex flex-col bg-donegeon-brown/80 hover:border-donegeon-accent transition-colors border border-donegeon-gray">
            <CardHeader>
            ...
            <CardContent className="flex-grow flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-donegeon-accent mt-4 font-semibold">{pack.items}</p>
              </div>
